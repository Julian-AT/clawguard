            ...
            >
              ...
              <div className="p-4">
                {tier.name === "Enterprise" && (
                  <p className="text-sm mb-4">Everything in Team +</p>
                )}
